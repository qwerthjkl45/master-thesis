...
def process_command_args(arguments):
    ...
    return phone, batch_size, train_size, learning_rate, num_train_iters, \
            w_content, w_color, w_texture, w_tv, w_Mssim, \
...
def process_test_model_args(arguments):
    ...
    if phone == "":
        ...
        sys.exit()
    print('====', phone)
    return phone, dped_dir, test_subset, iteration, resolution, use_gpu, model_dir
...
def extract_crop(image, resolution, phone, res_sizes):
    ...
    if resolution == "orig" or resolution == "five_k":
        return image
