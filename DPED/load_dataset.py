...
def load_test_data(phone, dped_dir, IMAGE_SIZE):
    ...
    test_directory_phone = dped_dir +  '/test_data/iphone/'
    test_directory_dslr = dped_dir + '/test_data/canon/'
    print(test_directory_dslr)
    #test_directory_phone = dped_dir +  '/test/patches/iphone/'
    #test_directory_dslr = dped_dir + '/test/patches/canon/'
    ...
    #TEST_IMAGES = np.random.choice(np.arange(0, NUM_TEST_IMAGES), 5, replace=False)
    NUM_TEST_IMAGES = 1
